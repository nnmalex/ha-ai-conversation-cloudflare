/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2041a8f9b06bf21ca6358b7577c44379)
// Runtime types generated with workerd@1.20260329.1 2026-03-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HomeAssistantAgent";
	}
	interface Env {
		AI: Ai;
		...
		HOME_ASSISTANT_AGENT: DurableObjectNamespace<import("./src/index").HomeAssistantAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODEL" | "TIMER_SLOTS" | "HA_MCP_URL" | "HA_ACCESS_TOKEN" | "AGENT_API_KEY">> {}
}
